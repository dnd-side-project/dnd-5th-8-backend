...
public interface AnswerRepository extends JpaRepository<Answer, Long> {
    ...
    @Query(value = "select * from answer a where a.space_id= :spaceId and a.question_id= :questionId", nativeQuery = true) //space id, question id
    List<Answer> getAnswers(@Param("spaceId") Long spaceId, @Param("questionId") Long questionId);
}
